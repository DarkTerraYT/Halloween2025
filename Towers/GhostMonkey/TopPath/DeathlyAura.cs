...
public class DeathlyAura : ModUpgrade<GhostMonkey>
{
    public override void ApplyUpgrade(TowerModel towerModel)
    {
        ...
        RateSupportModel rateSupport = new("DeathlyAura_Buff2", 0.75f, true, "DeathlyAura_Buff2", true, 1, filter, "", "");
        rateSupport.ApplyBuffIcon<DeathlyAuraBuffIcon>();
        towerModel.AddBehavior(rateSupport);
        var buffIcon2 = new RateSupportModel("", 1, true, "", false, 0, filter, "", ""); // Buff Icon on DamageSupportModel doesn't work for whatever reason
    ...
    public override string Description => "DOT does 10x more damage at a 4x faster tick rate. All nearby jiangsu do extra damage and every jiangsu attacks faster.";
