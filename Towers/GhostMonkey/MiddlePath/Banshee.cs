...
public class Banshee : ModUpgrade<GhostMonkey>
{
    public override string Description =>
        "Ghost monkey is now a Banshee, screaming at bloons. This freezes them in place for a very short, and causes ghost monkeys to do even more damage to these bloons.";
    ...
    public override void ApplyUpgrade(TowerModel towerModel)
    {
        ...
        if (towerModel.tiers[Top] >= 3 || towerModel.tiers[Bottom] >= 3) weapon = weapon.Duplicate();
        ...
        var DOT = Game.instance.model.GetTower("MortarMonkey", pathThreeTier: 3)
            .GetDescendant<AddBehaviorToBloonModel>().Duplicate();
        ...
        if (towerModel.tiers[Top] >= 3 || towerModel.tiers[Bottom] >= 3) towerModel.GetAttackModel().AddWeapon(weapon);
    }
}