...
public class Salvation : ModUpgrade<GhostMonkey>
{
    public override string Description =>
        "Bloons hit by the spectre release their soul, their strength tied to the strength of the bloon. Also does more damage, and attacks faster.";
    ...
    public override void ApplyUpgrade(TowerModel towerModel)
    {
        ...
        var createProj = new CreateProjectileOnContactModel("CreateProjectileOnContactModel_", projectile.Duplicate(),
    ...
    {
        public static readonly HashSet<ObjectId> ModifiedBloons = new();

        public static bool Prefix(CreateProjectileOnContact __instance, Bloon bloon)
        {
            if (!__instance.projectile.projectileModel.id.StartsWith("h25_salvation_")) return true;
            if (ModifiedBloons.Contains(bloon.Id)) return false;
            ...
            if (projectile.name == "BloonSoul_DoubleDamage") projectile.GetDamageModel().damage *= 2;
