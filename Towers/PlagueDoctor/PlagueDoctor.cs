...
public class PlagueDoctor : ModHero
{
    ...
    public override string Description =>
        "Amog is a doctor who deals in diseases. Though, instead of curing them, he spreads them! Don't worry, these diseases can only infect bloons as their immune systems are practically non-existent! Can also see camo bloons.";
    ...
    public override void ModifyBaseTowerModel(TowerModel towerModel)
    {
        ...
        var addBehaviors = Game.instance.model.GetTower(TowerType.MortarMonkey, pathThreeTier: 2).GetWeapon().projectile
