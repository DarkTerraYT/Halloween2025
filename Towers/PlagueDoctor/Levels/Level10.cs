...
public class Level10 : HeroLevel
{
    public override string Description =>
        "Ability, Plague Bringer: Spawns a plague bloon, which all spread a mega plague to other bloons. This mega plague cannot spread to other bloons.";
    ...
    {
        var ability = new AbilityModel("plague_bringer_1", "Plague Bringer",
            "Spawns a plague bloon, which all spread a mega plague to other bloons.",
